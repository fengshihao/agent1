...
2. **推荐 · 预编译**：weizhi publish Maven 后打 tgz 或上传 Actions artifact；agent1 Secrets：**`WEIZHI_PREBUILT_URL`** +（artifact/私有下载时）**`WEIZHI_GITHUB_TOKEN`**。详见 [`weizhi-prebuilt/README.md`](weizhi-prebuilt/README.md)
